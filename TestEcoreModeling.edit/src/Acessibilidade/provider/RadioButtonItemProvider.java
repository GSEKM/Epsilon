...
/**
 * This is the item provider adapter for a {@link Acessibilidade.RadioButton} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RadioButton_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RadioButton_id_feature", "_UI_RadioButton_type"),
				 AcessibilidadePackage.Literals.RADIO_BUTTON__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AcessibilidadePackage.Literals.RADIO_BUTTON__TEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addContentDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RadioButton_contentDescription_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RadioButton_contentDescription_feature", "_UI_RadioButton_type"),
				 AcessibilidadePackage.Literals.RADIO_BUTTON__CONTENT_DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
