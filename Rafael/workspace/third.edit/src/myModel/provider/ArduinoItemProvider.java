...
/**
 * This is the item provider adapter for a {@link myModel.Arduino} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArduinoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyModelPackage.Literals.ARDUINO__BOARD,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MyModelPackage.Literals.ARDUINO__MODULES);
		}
	...
	public String getText(Object object) {
		String label = ((Arduino)object).getBoard();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Arduino.class)) {
			case MyModelPackage.ARDUINO__BOARD:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case MyModelPackage.ARDUINO__MODULES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MyModelPackage.Literals.ARDUINO__MODULES,
				 MyModelFactory.eINSTANCE.createModule()));
	}
