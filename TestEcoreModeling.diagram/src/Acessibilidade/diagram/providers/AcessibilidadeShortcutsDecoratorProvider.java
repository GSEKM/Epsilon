 ...
 * @generated
 */
public class AcessibilidadeShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = Acessibilidade.diagram.part.AcessibilidadeDiagramEditorPlugin.getInstance()
