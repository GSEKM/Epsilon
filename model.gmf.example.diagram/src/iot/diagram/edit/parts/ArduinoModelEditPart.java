 ...
 * @generated
 */
public class ArduinoModelEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(IotVisualIDRegistry.getType(iot.diagram.edit.parts.ArduinoModelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ArduinoModelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = IotParserProvider.getParser(IotElementTypes.Arduino_2006, getParserElement(),
					IotVisualIDRegistry.getType(iot.diagram.edit.parts.ArduinoModelEditPart.VISUAL_ID));
		}
		return parser;
	}
