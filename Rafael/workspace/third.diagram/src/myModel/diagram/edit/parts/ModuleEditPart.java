...
public class ModuleEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new myModel.diagram.edit.policies.ModuleItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof myModel.diagram.edit.parts.ModuleNameEditPart) {
			((myModel.diagram.edit.parts.ModuleNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureModuleLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(myModel.diagram.part.MyModelVisualIDRegistry
