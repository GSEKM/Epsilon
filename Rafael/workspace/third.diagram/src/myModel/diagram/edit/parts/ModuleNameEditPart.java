...
public class ModuleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new myModel.diagram.edit.policies.MyModelTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return myModel.diagram.providers.MyModelElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = myModel.diagram.providers.MyModelParserProvider.getParser(
					myModel.diagram.providers.MyModelElementTypes.Module_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					myModel.diagram.edit.parts.MyModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
