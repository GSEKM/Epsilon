...
public class IotDiagramUpdater {
	...
	public static List<IotNodeDescriptor> getBoard_1000SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getModulo().iterator(); it.hasNext();) {
	 ...
	 * @generated
	 */
	public static List<IotLinkDescriptor> getArduino_2002ContainedLinks(View view) {
	...
	* @generated
	*/
	public static List<IotLinkDescriptor> getMotor_2003ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<IotLinkDescriptor> getMotor_2003IncomingLinks(View view) {
		Motor modelElement = (Motor) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
		LinkedList<IotLinkDescriptor> result = new LinkedList<IotLinkDescriptor>();
		result.addAll(getIncomingFeatureModelFacetLinks_Arduino_Conector_4004(modelElement, crossReferences));
		return result;
	}
	...
	* @generated
	*/
	public static List<IotLinkDescriptor> getMotor_2003OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	private static Collection<IotLinkDescriptor> getIncomingFeatureModelFacetLinks_Arduino_Conector_4004(Motor target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<IotLinkDescriptor> result = new LinkedList<IotLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() == IotPackage.eINSTANCE.getArduino_Conector()) {
				result.add(new IotLinkDescriptor(setting.getEObject(), target, IotElementTypes.ArduinoConector_4004,
	...
	private static Collection<IotLinkDescriptor> getOutgoingFeatureModelFacetLinks_Arduino_Conector_4004(
		...
		for (Iterator<?> destinations = source.getConector().iterator(); destinations.hasNext();) {
			...
			result.add(new IotLinkDescriptor(source, destination, IotElementTypes.ArduinoConector_4004,
					ArduinoConectorEditPart.VISUAL_ID));
		}
		return result;
	}
