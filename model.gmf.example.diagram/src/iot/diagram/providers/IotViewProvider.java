...
public class IotViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = IotVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = IotVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				...
				if (!BoardEditPart.MODEL_ID.equals(IotVisualIDRegistry.getModelID(op.getContainerView()))) {
		...
		return ArduinoEditPart.VISUAL_ID == visualID || MotorEditPart.VISUAL_ID == visualID;
	}
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = IotVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != IotVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(BoardEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = IotVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
			visualID = IotVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ArduinoEditPart.VISUAL_ID:
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case MotorConectorMotorMotorEditPart.VISUAL_ID:
			return createMotorConectorMotorMotor_4006(containerView, index, persisted, preferencesHint);
		}
	...
	*/
	public Node createArduino_2006(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(IotVisualIDRegistry.getType(ArduinoEditPart.VISUAL_ID));
	...
	*/
	public Node createMotor_2007(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(IotVisualIDRegistry.getType(MotorEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	*/
	public Edge createArduinoConector_4005(View containerView, int index, boolean persisted,
		...
		edge.setType(IotVisualIDRegistry.getType(ArduinoConectorEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createMotorConectorMotorMotor_4006(View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(IotVisualIDRegistry.getType(MotorConectorMotorMotorEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
		...
		Node label6006 = createLabel(edge, IotVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!BoardEditPart.MODEL_ID.equals(IotVisualIDRegistry.getModelID(containerView))) {
			...
			shortcutAnnotation.getDetails().put("modelID", BoardEditPart.MODEL_ID); //$NON-NLS-1$
