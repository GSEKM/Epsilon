...
/**
 * This is the item provider adapter for a {@link endlabels.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSourceLabelPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EndlabelsPackage.Literals.ASSOCIATION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EndlabelsPackage.Literals.ASSOCIATION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Source Label feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSourceLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_sourceLabel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_sourceLabel_feature", "_UI_Association_type"),
				 EndlabelsPackage.Literals.ASSOCIATION__SOURCE_LABEL,
				 true,
				 false,
				 false,
	...
	protected void addTargetLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_targetLabel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_targetLabel_feature", "_UI_Association_type"),
				 EndlabelsPackage.Literals.ASSOCIATION__TARGET_LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
