 ...
 * </p>
 * <ul>
 *   <li>{@link myModel.impl.ArduinoImpl#getBoard <em>Board</em>}</li>
 *   <li>{@link myModel.impl.ArduinoImpl#getModules <em>Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArduinoImpl extends EObjectImpl implements Arduino {
	...
	protected EClass eStaticClass() {
		return MyModelPackage.Literals.ARDUINO;
	}
	...
	public void setBoard(String newBoard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyModelPackage.ARDUINO__BOARD, oldBoard, board));
	}
	...
	public EList<Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList<Module>(Module.class, this, MyModelPackage.ARDUINO__MODULES);
		}
		return modules;
	}
