 ...
 * @generated
 */
public class MyModelShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = myModel.diagram.part.MyModelDiagramEditorPlugin.getInstance()
