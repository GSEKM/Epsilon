 ...
 * @generated
 */
public class MotorGrausEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(IotVisualIDRegistry.getType(iot.diagram.edit.parts.MotorGrausEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public MotorGrausEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = IotParserProvider.getParser(IotElementTypes.Motor_2003, getParserElement(),
					IotVisualIDRegistry.getType(iot.diagram.edit.parts.MotorGrausEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new MotorLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MotorLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MotorLabelFigure() {
			this.setText("Motor");
		}
