 ...
 * @generated
 */
public class MyModelValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = myModel.diagram.part.MyModelDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof myModel.diagram.part.MyModelDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && myModel.diagram.edit.parts.ArduinoEditPart.MODEL_ID
		...
		PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					myModel.diagram.part.MyModelDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", //$NON-NLS-1$
							e);
				}
			}
		});
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				myModel.diagram.part.MyModelDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
