 ...
 * @generated
 */
public class MotorItemSemanticEditPolicy extends IotBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IotVisualIDRegistry.getVisualID(incomingLink) == ArduinoConectorEditPart.VISUAL_ID) {
