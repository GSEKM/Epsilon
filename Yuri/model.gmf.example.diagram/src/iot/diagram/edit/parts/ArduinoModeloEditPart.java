...
import iot.diagram.edit.policies.IotTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ArduinoModeloEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(IotVisualIDRegistry.getType(iot.diagram.edit.parts.ArduinoModeloEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ArduinoModeloEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new IotTextSelectionEditPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = IotParserProvider.getParser(IotElementTypes.Arduino_2002, getParserElement(),
					IotVisualIDRegistry.getType(iot.diagram.edit.parts.ArduinoModeloEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, IotEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new ArduinoLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ArduinoLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ArduinoLabelFigure() {
