 ...
 * @generated
 */
public class AcessibilidadeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AcessibilidadePackage.APPLICATION: {
				Application application = (Application)theEObject;
				T result = caseApplication(application);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.WINDOW: {
				Window window = (Window)theEObject;
				T result = caseWindow(window);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.OUTPUT: {
				Output output = (Output)theEObject;
				T result = caseOutput(output);
				if (result == null) result = caseWidget(output);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.WIDGET: {
				Widget widget = (Widget)theEObject;
				T result = caseWidget(widget);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.TEXT_OUTPUT: {
				Text_Output text_Output = (Text_Output)theEObject;
				T result = caseText_Output(text_Output);
				if (result == null) result = caseOutput(text_Output);
				if (result == null) result = caseWidget(text_Output);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.IMAGE: {
				Image image = (Image)theEObject;
				T result = caseImage(image);
				if (result == null) result = caseOutput(image);
				if (result == null) result = caseWidget(image);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.INPUT: {
				Input input = (Input)theEObject;
				T result = caseInput(input);
				if (result == null) result = caseWidget(input);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.TEXT_INPUT: {
				Text_Input text_Input = (Text_Input)theEObject;
				T result = caseText_Input(text_Input);
				if (result == null) result = caseInput(text_Input);
				if (result == null) result = caseWidget(text_Input);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.COMBO_BOX: {
				ComboBox comboBox = (ComboBox)theEObject;
				T result = caseComboBox(comboBox);
				if (result == null) result = caseInput(comboBox);
				if (result == null) result = caseWidget(comboBox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcessibilidadePackage.RADIO_GROUP: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Text Output</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Text Output</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseText_Output(Text_Output object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseText_Input(Text_Input object) {
		return null;
	}
