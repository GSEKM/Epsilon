...
public class WrappingLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(IotVisualIDRegistry.getType(iot.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = IotParserProvider.getParser(IotElementTypes.MotorConectorMotorMotor_4006, getParserElement(),
