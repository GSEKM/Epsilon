...
/**
 * This is the item provider adapter for a {@link Acessibilidade.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends OutputItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_imagePath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_imagePath_feature", "_UI_Image_type"),
				 AcessibilidadePackage.Literals.IMAGE__IMAGE_PATH,
				 true,
				 false,
				 false,
