 ...
 * 
 */
package Acessibilidade.diagram.edit.parts;
...
public class ApplicationEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Acessibilidade"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Acessibilidade.diagram.edit.policies.ApplicationItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				Acessibilidade.diagram.part.AcessibilidadeVisualIDRegistry.TYPED_INSTANCE));
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new Acessibilidade.diagram.edit.commands.AcessibilidadeCreateShortcutDecorationsCommand(
