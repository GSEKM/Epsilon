 ...
 * @generated
 */
public class ClassTest extends NamedElementTest {
	 ...
	 */
	@Override
	protected endlabels.Class getFixture() {
		return (endlabels.Class)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(EndlabelsFactory.eINSTANCE.createClass());
	}
