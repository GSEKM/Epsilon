 ...
 * @generated
 */
public class AcessibilidadeValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = Acessibilidade.diagram.part.AcessibilidadeDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof Acessibilidade.diagram.part.AcessibilidadeDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && Acessibilidade.diagram.edit.parts.ApplicationEditPart.MODEL_ID
