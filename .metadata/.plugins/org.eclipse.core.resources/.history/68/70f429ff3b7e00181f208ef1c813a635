...
/**
 * This is the item provider adapter for a {@link iot.Arduino} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  protected void addConectorPropertyDescriptor(Object object)
  {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arduino_conector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arduino_conector_feature", "_UI_Arduino_type"),
				 IotPackage.Literals.ARDUINO__CONECTOR,
				 true,
				 false,
				 true,
				 null,
