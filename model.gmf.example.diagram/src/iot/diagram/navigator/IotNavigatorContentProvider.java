...
public class IotNavigatorContentProvider implements ICommonContentProvider {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			ArrayList<IotNavigatorItem> result = new ArrayList<IotNavigatorItem>();
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews, BoardEditPart.MODEL_ID), file, false));
			return result.toArray();
		}

		if (parentElement instanceof IotNavigatorGroup) {
			IotNavigatorGroup group = (IotNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof IotNavigatorItem) {
			IotNavigatorItem navigatorItem = (IotNavigatorItem) parentElement;
	...
	*/
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case BoardEditPart.VISUAL_ID: {
			...
			IotNavigatorGroup links = new IotNavigatorGroup(Messages.NavigatorGroupName_Board_1000_links,
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<IotNavigatorItem> createNavigatorItems(Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<IotNavigatorItem> result = new ArrayList<IotNavigatorItem>(views.size());
		for (View nextView : views) {
			result.add(new IotNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<IotNavigatorItem> getForeignShortcuts(Diagram diagram, Object parent) {
		LinkedList<View> result = new LinkedList<View>();
