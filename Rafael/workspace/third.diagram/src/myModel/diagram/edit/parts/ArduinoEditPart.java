 ...
 * @generated
 */
public class ArduinoEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "MyModel"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new myModel.diagram.edit.policies.ArduinoItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new myModel.diagram.edit.policies.ArduinoCanonicalEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(myModel.diagram.part.MyModelVisualIDRegistry.TYPED_INSTANCE));
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(
							new ICommandProxy(new myModel.diagram.edit.commands.MyModelCreateShortcutDecorationsCommand(
