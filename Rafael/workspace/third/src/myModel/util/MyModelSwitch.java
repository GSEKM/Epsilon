...
public class MyModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MyModelPackage.ARDUINO: {
				Arduino arduino = (Arduino)theEObject;
				T result = caseArduino(arduino);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MyModelPackage.MÓDULO: {
				Módulo módulo = (Módulo)theEObject;
				T result = caseMódulo(módulo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MyModelPackage.MODULE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Módulo</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Módulo</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMódulo(Módulo object) {
		return null;
	}
