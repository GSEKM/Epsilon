 ...
 * @generated
 */
public class MotorNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(IotVisualIDRegistry.getType(iot.diagram.edit.parts.MotorNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public MotorNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = IotParserProvider.getParser(IotElementTypes.Motor_2007, getParserElement(),
					IotVisualIDRegistry.getType(iot.diagram.edit.parts.MotorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
