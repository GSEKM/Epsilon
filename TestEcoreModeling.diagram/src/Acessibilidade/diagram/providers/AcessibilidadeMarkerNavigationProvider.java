 ...
 * @generated
 */
public class AcessibilidadeMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = Acessibilidade.diagram.part.AcessibilidadeDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			Acessibilidade.diagram.part.AcessibilidadeDiagramEditorUtil.selectElementsInDiagram(editor,
