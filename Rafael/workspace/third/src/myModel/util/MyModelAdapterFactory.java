...
public class MyModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected MyModelSwitch<Adapter> modelSwitch =
		new MyModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseMódulo(Módulo object) {
				return createMóduloAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link myModel.Arduino <em>Arduino</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link myModel.Módulo <em>Módulo</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMóduloAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link myModel.Module <em>Module</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
