 ...
 * 
 */
package myModel.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(myModel.diagram.part.MyModelDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(myModel.diagram.part.Messages.MessageFormatParser_InvalidInputError,
